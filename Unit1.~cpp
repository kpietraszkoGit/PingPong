...
void __fastcall TPingPong::FormCreate(TObject *Sender)
{
  ...
  char * w; //stary string
  w="Witam w grze PingPong.\nLewy gracz startuje naciskaj¹c klawisze Q-góra, A-dó³, a prawy normalnie pos³uguje sie strza³kami (góra, dó³).\n\nKiedy odbijesz pi³kê na œrodku, ona przyœpiesza i zmienia k¹t. Im d³u¿ej grasz, pi³ka bedzie przyœpiesza³a.\nMi³ej gry! :) ";
